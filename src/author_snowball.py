...
VOCAB = {
    "Cibernética": ("cybernetic", "viable system", "vsm", "stafford beer", "ashby",
                    ...
                    "policy mix", "policy design", "instrument choice", "nodal", "digital government"),
    "Regulação econômica": ("regulation", "regulatory", "antitrust", "competition policy",
                            "competition law", "natural monopoly", "price control", "public utilit",
                            "regulatory state", "regulatory capture", "regulatory agency",
                            "regulatory governance", "smart regulation", "responsive regulation"),
