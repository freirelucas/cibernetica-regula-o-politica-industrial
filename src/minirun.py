...
SEEDS = {  # id -> (rótulo curto, eixo)
    ...
    # ── CIBERNÉTICA / SISTEMAS (expansão p/ 20; âncoras canônicas do corpus) ─
    "W1995875735": ("Shannon · Mathematical Theory of Communication", "Cyb"),
    "W1527571715": ("Wiener · Cybernetics", "Cyb"),
    "W2099069868": ("von Bertalanffy · General System Theory", "Cyb"),
    "W2101157755": ("Senge · The Fifth Discipline", "Cyb"),
    "W1492856410": ("Checkland · Systems Thinking, Systems Practice", "Cyb"),
    "W2493894436": ("Maturana & Varela · Autopoiesis and Cognition", "Cyb"),
    "W597091629": ("Forrester · Principles of Systems", "Cyb"),
    "W1601944394": ("Churchman · The Systems Approach", "Cyb"),
    "W2988934653": ("Sterman · Business Dynamics", "Cyb"),
    "W2037306909": ("Jackson · Systems Thinking (Creative Holism)", "Cyb"),
    # ── POLÍTICA INDUSTRIAL (expansão p/ 20; estado desenvolvimentista + SI) ─
    "W2017802748": ("Wade · Governing the Market", "PolInd"),
    "W2012275303": ("Evans · Embedded Autonomy", "PolInd"),
    "W1979968159": ("Hirschman · Strategy of Economic Development", "PolInd"),
    "W1490995146": ("Prebisch · Economic Development of Latin America", "PolInd"),
    "W2140409505": ("Schumpeter · Capitalism, Socialism and Democracy", "PolInd"),
    "W1535129021": ("Dosi · Technological Paradigms and Trajectories", "PolInd"),
    "W1576605329": ("Nelson · National Innovation Systems", "PolInd"),
    "W2120106358": ("Hausmann & Rodrik · Economic Development as Self-Discovery", "PolInd"),
    "W2064927380": ("Hidalgo & Hausmann · The Product Space", "PolInd"),
    "W1491554624": ("Abernathy & Utterback · Patterns of Industrial Innovation", "PolInd"),
    "W2013386523": ("Porter · The Competitive Advantage of Nations", "PolInd"),
    "W1999997471": ("Hekkert · Functions of Innovation Systems", "PolInd"),
    "W4302604455": ("Johnson · MITI and the Japanese Miracle", "PolInd"),
    "W2483843983": ("Chang · Kicking Away the Ladder", "PolInd"),
    "W2080485486": ("Gerschenkron · Economic Backwardness", "PolInd"),
    "W3121405033": ("Lin · New Structural Economics", "PolInd"),
    "W1502659095": ("Reinert · How Rich Countries Got Rich", "PolInd"),
